...
ENT.Base 			= "base_core3"
ENT.PrintName		= "Nortonv8 Core v2" -- The name the Core will come up as in the Spawnmenu
...
ENT.Purpose			= "To get stared at" -- The purpose of the entity
...
ENT.Delay			= 10
ENT.Dir				= "nhv2" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
