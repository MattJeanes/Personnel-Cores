...
ENT.Base 			= "base_core3"
ENT.PrintName		= "KillerToaster Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Purpose			= "Heaaalooo" -- The purpose of the entity
...
ENT.Delay			= 5
ENT.Dir				= "kilr" -- The name of your sub-folder, must be 4 characters.
/*---------------------------------------------------------
